...
use OpenRuntimes\Orchestrator\Models\Artifact\ArchiveArtifact;
use OpenRuntimes\Orchestrator\Models\Artifact\DownloadArtifact;
use OpenRuntimes\Orchestrator\Models\Artifact\ListArtifact;
use OpenRuntimes\Orchestrator\Models\Artifact\StatArtifact;
        ...
        $this->assertJsonStringEqualsJsonString(
            (string) \json_encode([
                ...
                'artifacts' => [
                    ...
                    ['id' => 'upload', 'type' => 'upload', 'depends' => 'build', 'in' => 'build.tar.gz', 'out' => 'https://example.com/upload', 'headers' => ['X-Appwrite-Project' => 'project'], 'chunked' => true],
