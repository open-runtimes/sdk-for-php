    ...
    public function test_create_serializes_artifacts_and_callback(): void
    {
        ...
        $jobs->create(
            ...
            artifacts: [
                ...
                new ArchiveArtifact('image', 'stores', 'stores.erofs', format: ArchiveFormat::Erofs, depends: 'job'),
                ...
                new MountArtifact('erofs', 'stores.erofs', 'layers/img', depends: 'image'),
        ...
        $this->assertJsonStringEqualsJsonString(
            (string) \json_encode([
                ...
                'artifacts' => [
                    ...
                    ['id' => 'image', 'type' => 'archive', 'depends' => 'job', 'in' => 'stores', 'out' => 'stores.erofs', 'format' => 'erofs'],
                    ...
                    ['id' => 'erofs', 'type' => 'mount', 'depends' => 'image', 'in' => 'stores.erofs', 'out' => 'layers/img'],
